...
def handle_client_connection(client_socket):
    ...
    try:
        ...
        # Extract Host header to determine destination
        host = None
        try:
        ...
        if host:
            try:
                # 
                # Establish upstream connection: Try HTTPS (443) first, fallback to HTTP (80)
                # We disable certificate verification because we are proxying raw traffic
            ...
            with secure_sock:
                # Downgrade Request: Remove compression and force close connection
                ...
                # Receive response from legitimate server
                response_data = b""
                ...
                # Strip Security Headers (HSTS) and Downgrade Links (https:// -> http://)
...
def run_ssl_strip():
    ...
    try:
        ...
        # Redirect port 80 traffic to this proxy using iptables
        ...
        # Cleanup firewall rules and close socket
